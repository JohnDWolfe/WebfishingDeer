...
func _ready():
	...
	Lure.assign_pattern_texture(ID, "pattern_calico", ID + ".species_deer", "res://Assets/Textures/PlayerPatterns/body_pattern_4_dog.png")
	Lure.assign_pattern_texture(ID, "pattern_collie", ID + ".species_deer", "res://Assets/Textures/PlayerPatterns/body_pattern_1_dog.png")
	Lure.assign_pattern_texture(ID, "pattern_spotted", ID + ".species_deer", "res://Assets/Textures/PlayerPatterns/body_pattern_3_dog.png")
	Lure.assign_pattern_texture(ID, "pattern_tux", ID + ".species_deer", "res://Assets/Textures/PlayerPatterns/body_pattern_2_dog.png")
